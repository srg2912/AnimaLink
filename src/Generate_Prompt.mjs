function generatePersonalityPrompt (name, looks, personality, language) {
    return `Create a detailed personality profile for a fictional character 
    named "${name}". The character identifies as a ${looks}.
...
function generateSpritePrompt (result, spritesString) {
    return `Analize the sentiments of the character in the following text: ${result}.
      ...
      Answer by only writing back the sprite you chose and nothing else, keep extension of the sprite.
